      ...
      <div className="max-w-[480px] mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center">
            <WalletMultiButton className="!bg-blue-600 hover:!bg-blue-700 !text-white !font-bold !py-2 !px-4 !rounded-lg !shadow-lg hover:!shadow-xl transition-all duration-200" />
          </div>
        </div>
